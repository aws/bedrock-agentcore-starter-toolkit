"""Implementation for bootstrap command to be compatible with the outputs from the configure command."""
...
def resolve_agent_config_with_project_context(ctx: ProjectContext, agent_config: BedrockAgentCoreAgentSchema):
    ...
    ):  # bootstrap sets entrypoint to . to indicate that source code should be provided by bootstrap
