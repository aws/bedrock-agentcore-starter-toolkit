...
class ConfigureResult(BaseModel):
    ...
    dockerfile_path: Path | None = Field(None, description="Path to generated Dockerfile")
    dockerignore_path: Path | None = Field(None, description="Path to generated .dockerignore")
    runtime: str | None = Field(None, description="Container runtime name")
    runtime_type: str | None = Field(None, description="Python runtime version for direct_code_deploy")
    ...
    s3_path: str | None = Field(None, description="S3 URI")
    ...
    network_mode: str | None = Field(None, description="Network mode (PUBLIC or VPC)")
    network_subnets: list[str] | None = Field(None, description="VPC subnet IDs")
    network_security_groups: list[str] | None = Field(None, description="VPC security group IDs")
    network_vpc_id: str | None = Field(None, description="VPC ID")
...
class LaunchResult(BaseModel):
    ...
    # Cloud mode fields
    ecr_uri: str | None = Field(default=None, description="Versioned ECR image URI (e.g., {repo}:20260108-120435-123)")
...
class StatusConfigInfo(BaseModel):
    ...
    network_security_groups: list[str] | None = None
    network_vpc_id: str | None = None
    ...
    idle_timeout: int | None = Field(None, description="Idle runtime session timeout in seconds")
    max_lifetime: int | None = Field(None, description="Maximum instance lifetime in seconds")
