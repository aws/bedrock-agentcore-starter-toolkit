...
1. Stores the audience configuration in `.bedrock_agentcore.yaml`
1. Returns the issuer URL to configure in your external service
...
1. Validate the audience claim matches your configured audience
1. Fetch the JWKS from `{issuer_url}/.well-known/jwks.json`
