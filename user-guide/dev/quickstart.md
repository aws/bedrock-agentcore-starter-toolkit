...
Start from the root of your AgentCore project. If you don't have a project yet, create one with [`agentcore create`](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/create/quickstart.html).
...
1. Modify the agent's system prompt or add a new tool

1. Save the file

1. Watch the dev server output - you'll see:
...
1. Invoke your agent again to see the changes immediately:
...
- **Deploy your agent**: Use [`agentcore launch`](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/runtime/quickstart.html) for simple deployments
- **Add more tools**: Integrate MCP tools or custom functions
- **Configure memory**: Set up [AgentCore Memory](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/memory/quickstart.html) for stateful agents
