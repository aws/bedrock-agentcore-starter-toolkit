"""Unit tests for YAML output generation in bootstrap."""

import yaml

from bedrock_agentcore_starter_toolkit.bootstrap.util.bootstrap_yaml import (
    write_minimal_bootstrap_project_yaml,
)
...
class TestYAMLOutput:
    ...
    def test_yaml_file_created(self, sample_project_context):
        ...
        # Write YAML file
        yaml_path = write_minimal_bootstrap_project_yaml(sample_project_context)
    ...
    def test_yaml_sets_bootstrap_flag(self, sample_project_context):
        """Test that YAML sets is_agentcore_bootstrap_project flag to True."""
        # Ensure output directory exists
        sample_project_context.output_dir.mkdir(parents=True, exist_ok=True)
        ...
        # Verify bootstrap flag is set to True
        assert "is_agentcore_bootstrap_project" in data
        assert data["is_agentcore_bootstrap_project"] is True
